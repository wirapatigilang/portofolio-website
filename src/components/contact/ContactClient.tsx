      ...
      >
        <div className="space-y-4">
          <motion.h1 
            ...
            id="contact-heading" 
            className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl bg-gradient-to-r from-foreground via-foreground/90 to-foreground/75 bg-clip-text text-transparent"
          >
            Mari Berkolaborasi
          </motion.h1>
          <motion.p 
          ...
          >
            Punya ide proyek, tawaran pekerjaan, atau sekadar ingin menyapa? Silakan isi formulir atau hubungi saya langsung melalui platform di bawah ini.
          </motion.p>
        </div>
